      ...
      <div className="flex flex-col flex-1 relative">
        {!selectedUser ? (
          ...
          <>
            {/* Header */}
            <div
              className={` flex gap-6 px-4 py-3 border-b border-gray-400 dark:border-gray-600 dark: items-center fixed w-full bg-gray-50 dark:bg-gray-950`}
            >
              <button
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-4 mb-17 mt-17">
              {messages.map((msg) => (
                <div
                  key={msg.id}
